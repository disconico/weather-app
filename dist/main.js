...
const display = (() => {
  ...
  function renderWeather(weatherData, city) {
    ...
    day1DayName.textContent = `${(0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(
    ...
    day2DayName.textContent = `${(0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(
